...
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (1, 'shenbo', '1', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (2, 'fnadmin', '2', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (3, 'fnadmin1', '3', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (4, 'org1user1', '4', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (5, 'org1cwjl', '5', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (6, 'org1zjl', '6', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (7, 'org1zj1', '7', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (8, 'org1cbkj1', '8', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (9, 'org1mynq1', '9', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (10, 'org1myjl', '10', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (11, 'gro1pzzhzj', '11', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (12, 'gro1kj1', '12', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (13, 'gro1zj1', '13', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (14, 'gro1zj2', '14', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (15, 'gro1zj3', '15', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (16, 'gro1zj4', '16', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (17, 'gro1zj5', '17', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (18, 'gro1zjjl', '18', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (19, 'gro1zjzj', '19', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (20, 'gro1xmjl', '20', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (21, 'gro1jh1', '21', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (22, 'gro1cwzj', '22', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (23, 'singzj', '23', 'N');

INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (24, 'org2user1', '24', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (25, 'org2cwjl', '25', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (26, 'org2zjl', '26', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (27, 'org2zj1', '27', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (28, 'org2cbkj1', '28', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (29, 'org2mynq1', '29', 'N');
INSERT INTO USERS (ID, AD_ACCOUNT, PERNR, DEFUNCT_IND) VALUES (30, 'org2myjl', '30', 'N');


insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('leichanglin', '雷长林', '', '', '', '', 'leichanglin 雷长林', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('lili3', '黎丽', '研发工程师', 'lili3@wilmar-intl.com', '02131153096', '', 'lili3 黎丽 研发工程师 lili3@wilmar-intl.com 02131153096', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('libaocheng', '', '', '', '', '', 'libaocheng', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('liguangxiang', '', '', '', '', '', 'liguangxiang', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('lijia', '李嘉', '', '', '', '', 'lijia 李嘉', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('lijin3', '李瑾', 'RD', '', '', '', 'lijin3 李瑾 RD', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('liliang', '李良', '', '', '', '', 'liliang 李良', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('limo', '李沫', 'IT', '', '82208356', '', 'limo 李沫 IT  82208356', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('lixuewen', '', '', '', '', '', 'lixuewen', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('liymkisc', '李玉美', '', '', '', '', 'liymkisc 李玉美', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('liyuntong', '', '', '', '', '', 'liyuntong', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('lizhaoan', '', '', '', '', '', 'lizhaoan', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('lizhengjun', '李政军', '嘉里粮油(营口)有限公司 人力资源主任', 'lizhengjun@wilmar-intl.com', '0417-6269039', '', 'lizhengjun 李政军 嘉里粮油(营口)有限公司 人力资源主任 lizhengjun@wilmar-intl.com 0417-6269039', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('lizhonghui', '', '', '', '', '', 'lizhonghui', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('liangbo', '梁博', '', '', '', '', 'liangbo 梁博', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('liangjun1', '梁军', '', 'liangjun1@wilmar-intl.com', '', '', 'liangjun1 梁军  liangjun1@wilmar-intl.com', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('liangyiwen', '梁依雯', '', '', '', '', 'liangyiwen 梁依雯', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('linweie', '林伟娥', '泉州福海粮油工业有限公司-人事行政部-行政（保险）文员林伟娥', 'linweie@wilmar-intl.com', '0595-36168010', '', 'linweie 林伟娥 泉州福海粮油工业有限公司-人事行政部-行政（保险）文员林伟娥 linweie@wilmar-intl.com 0595-36168010', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('linzushun', '林祖顺', '泉州福海粮油工业有限公司-财务部IT组-林祖顺', 'linzushun@wilmar-intl.com', '0595-36168005', '', 'linzushun 林祖顺 泉州福海粮油工业有限公司-财务部IT组-林祖顺 linzushun@wilmar-intl.com 0595-36168005', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('liujie', '刘杰', '', '', '', '', 'liujie 刘杰', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('liukuiwei', '刘魁伟', '', '', '', '', 'liukuiwei 刘魁伟', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('liulian', '刘联', '北京管理中心人事行政部-HR', 'liulian@wilmar-intl.com', '010-52177009', '', 'liulian 刘联 北京管理中心人事行政部-HR liulian@wilmar-intl.com 010-52177009', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('liuqingyuan', '刘庆远', '济南兼职IT', '', '', '', 'liuqingyuan 刘庆远 济南兼职IT', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('liuruixue', '刘瑞雪', '', '', '', '', 'liuruixue 刘瑞雪', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('lvxianjing', '', '', '', '', '', 'lvxianjing', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('sjz-luochao', '罗超', '', '', '', '', 'sjz-luochao 罗超', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('luojianhui', 'SZH-OF.罗剑辉', '南海油脂工业(赤湾)有限公司公共事务主任', 'luojianhui@wilmar-intl.com', '075526694378', '', 'luojianhui SZH-OF.罗剑辉 南海油脂工业(赤湾)有限公司公共事务主任 luojianhui@wilmar-intl.com 075526694378', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('luozheng', '', '云南阔海', '', '', '', 'luozheng  云南阔海', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('luowei', '骆威', '研发技术员', 'luowei@wilmar-intl.com', '02131153029', '', 'luowei 骆威 研发技术员 luowei@wilmar-intl.com 02131153029', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('madianping', '马点平', '研发技术员', 'madianping@wilmar-intl.com', '02131153018', '', 'madianping 马点平 研发技术员 madianping@wilmar-intl.com 02131153018', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('mahaishuang', '马海双', '', '', '', '', 'mahaishuang 马海双', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('majiangang', '马建刚', '', '', '0994-2719235', '', 'majiangang 马建刚   0994-2719235', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('majinying', '马金营', '', '', '', '', 'majinying 马金营', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('malina', '马丽娜', '', '', '', '', 'malina 马丽娜', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('maming', 'XPG-FS.马明', '益海嘉里(兴平)食品工业有限公司-信息组-网络管理员', 'maming@wilmar-intl.com', '029-38000052', '', 'maming XPG-FS.马明 益海嘉里(兴平)食品工业有限公司-信息组-网络管理员 maming@wilmar-intl.com 029-38000052', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('manaizhong', '马乃忠', '研发实验员', 'manaizhong@wilmar-intl.com', '02131153087', '', 'manaizhong 马乃忠 研发实验员 manaizhong@wilmar-intl.com 02131153087', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('maoaijun', '毛爱军', '研发经理', 'maoaijun@wilmar-intl.com', '02131153132', '', 'maoaijun 毛爱军 研发经理 maoaijun@wilmar-intl.com 02131153132', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('mujun', '穆君', '', '', '', '', 'mujun 穆君', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('pantaojiang', '', '', '', '', '', 'pantaojiang', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('panzhicheng', 'SZH-WH.潘志成', '深圳南海粮食工业有限公司IT', 'panzhicheng@wilmar-intl.com', '0755-26839894', '', 'panzhicheng SZH-WH.潘志成 深圳南海粮食工业有限公司IT panzhicheng@wilmar-intl.com 0755-26839894', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('pengyuanyuan', '', '', '', '', '', 'pengyuanyuan', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('pujingwu', '浦京武', '经理', '', '82218573', '', 'pujingwu 浦京武 经理  82218573', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('qiuyinglin', '邱映霖', '', '', '', '', 'qiuyinglin 邱映霖', 'N');
insert into USR (ID, NAME, description, EMAIL, TELNO, CELNO, SEARCH_PHRASE, DEFUNCT_IND) values ('renguodong', 'SHG-FS.任国栋', '秦皇岛金海食品工业有限公司-CW', 'renguodong@wilmar-intl.com', '0335-5066601', '', 'renguodong SHG-FS.任国栋 秦皇岛金海食品工业有限公司-CW renguodong@wilmar-intl.com 0335-5066601', 'N');


insert into pu (id, DEFUNCT_IND, pernr) values ('fnadmin', 'N', '2');
insert into pu (id, DEFUNCT_IND, pernr) values ('fnadmin1', 'N', '3');
insert into pu (id, DEFUNCT_IND, pernr) values ('leichanglin', 'N', '21');
insert into pu (id, DEFUNCT_IND, pernr) values ('liangbo', 'N', '9');
insert into pu (id, DEFUNCT_IND, pernr) values ('liangjun1', 'N', '4');
insert into pu (id, DEFUNCT_IND, pernr) values ('liangyiwen', 'N', '8');
insert into pu (id, DEFUNCT_IND, pernr) values ('libaocheng', 'N', '11');
insert into pu (id, DEFUNCT_IND, pernr) values ('liguangxiang', 'N', '20');
insert into pu (id, DEFUNCT_IND, pernr) values ('lijia', 'N', '13');
insert into pu (id, DEFUNCT_IND, pernr) values ('lijin3', 'N', '14');
insert into pu (id, DEFUNCT_IND, pernr) values ('lili3', 'N', '12');
insert into pu (id, DEFUNCT_IND, pernr) values ('liliang', 'N', '15');
insert into pu (id, DEFUNCT_IND, pernr) values ('limo', 'N', '16');
insert into pu (id, DEFUNCT_IND, pernr) values ('linweie', 'N', '7');
insert into pu (id, DEFUNCT_IND, pernr) values ('linzushun', 'N', '6');
insert into pu (id, DEFUNCT_IND, pernr) values ('liujie', 'N', '28');
insert into pu (id, DEFUNCT_IND, pernr) values ('liukuiwei', 'N', '25');
insert into pu (id, DEFUNCT_IND, pernr) values ('liulian', 'N', '30');
insert into pu (id, DEFUNCT_IND, pernr) values ('liuqingyuan', 'N', '29');
insert into pu (id, DEFUNCT_IND, pernr) values ('liuruixue', 'N', '24');
insert into pu (id, DEFUNCT_IND, pernr) values ('lixuewen', 'N', '17');
insert into pu (id, DEFUNCT_IND, pernr) values ('liymkisc', 'N', '18');
insert into pu (id, DEFUNCT_IND, pernr) values ('liyuntong', 'N', '19');
insert into pu (id, DEFUNCT_IND, pernr) values ('lizhengjun', 'N', '5');
insert into pu (id, DEFUNCT_IND, pernr) values ('lizhonghui', 'N', '10');
insert into pu (id, DEFUNCT_IND, pernr) values ('luojianhui', 'N', '26');
insert into pu (id, DEFUNCT_IND, pernr) values ('luowei', 'N', '23');
insert into pu (id, DEFUNCT_IND, pernr) values ('luozheng', 'N', '1');
insert into pu (id, DEFUNCT_IND, pernr) values ('lvxianjing', 'N', '27');
