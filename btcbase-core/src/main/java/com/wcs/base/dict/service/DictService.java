...
public class DictService implements Serializable {
	 ...
	 */
	public List findTablePropertiesWithList(Class clazz, String property1, String property2) {
		StringBuilder sb = new StringBuilder("select ");
		sb.append(property1).append(",").append(property2).append(" from ").append(clazz.getSimpleName());
	 ...
	 */
	public Map<Object, Object> findTablePropertiesWithMap(Class<? extends BaseEntity> clazz, String property1, String property2) {
	 ...
	 * @return  List<SelectItem>中的 SelectItem 为JSF 的类，它包含 SelectBox 的 value/caption，供标签 <f:selectItem> 和 <f:selectItems> 使用
	 */
	public List<SelectItem> findTablePropertiesWithSelectItem(Class clazz, String property1, String property2) {
		List dicts = findTablePropertiesWithList(clazz, property1, property2);
