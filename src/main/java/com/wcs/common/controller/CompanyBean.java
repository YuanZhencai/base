...
public class CompanyBean {
	@EJB CompanyService companyManagerService;
	...
	public void searchTaxauthority(){
		List<Taxauthority> bbv = companyManagerService.findTaxauthority(taxauthority);
		taxauthorityLazyModel = new PageModel(bbv, false);
	}
	public LazyDataModel<O> getInsertLazyModel() {
		return insertLazyModel;
	}
	public void setInsertLazyModel(
			LazyDataModel<O> insertLazyModel) {
	...
	public void search(){
		List<CompanyManagerModel> bbv = companyManagerService.getCompanyManagerModel(companyManagerModel);
	...
	public void saveOrUpdateCompany(){
		...
		companymstr.setTaxauthority(this.selectt);
		}
		if(flag){
		...
		companymstr.setUpdatedBy("11");
		companymstr.setCreatedDatetime(new Date());
		companymstr.setCreatedBy("11");
...
//		o.setId(1l);
//		o.setDefunctInd("Y");
		this.companyManagerService.saveOrUpdate(companymstr,flag,selectt);
