 ...
 */
package com.wcs.schedulerapp.common;
...
public class JobInfo implements java.io.Serializable
{
    ...
    public JobInfo()
    {
        this("<Job ID>", "<Job Name>", "java:module/");//in WAS SHOULD USE:"java:comp/env/{yourJNDIname}"
    }
    ...
    {
    	System.out.println("~~~~~Expression of the schedule set in the object~~~~");
