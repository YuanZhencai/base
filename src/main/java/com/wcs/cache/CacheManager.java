/** * CacheManager.java 
 * Created on 2014年5月5日 下午3:11:36 
 */
...
public class CacheManager {
	...
	// 载入缓存
	public synchronized static void writeCache(String key, Cache obj) {
	...
	// 得到缓存。同步静态方法
	private synchronized static Cache getRamCache(String key) {
		return (Cache) cacheMap.get(key);
	}
