...
public class AccessException extends RuntimeException
{
   ...
   {
      super(throwable);
      this.message = new AccessExceptionStringMessage(throwable.getLocalizedMessage());
   }
    ...
    */
   public <E extends Enum<?>> AccessException(E key, Object... args)
   {
    ...
    * @param args Optional arguments to insert into the message
    */
   public <E extends Enum<?>> AccessException(E key, Throwable throwable, Object... args)
   {
      super(throwable);
      this.message = new AccessExceptionKeyMessage(key, args);
   }
    ...
    */
   public AccessException(List<Throwable> errors)
   {
      super();
