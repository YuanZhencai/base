...
_axUtils.loadCSS = function (url) {
    $('head').append('<link text="text/css" href="#{request.contextPath}/' + url + '" rel="Stylesheet" />');
};

_axUtils.loadJS = function (url) {
    $('head').append('<script text="text/javascript" language="JavaScript" src="#{request.contextPath}/' + url + '"></script>');
};
